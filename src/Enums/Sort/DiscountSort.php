...
/**
 * Discount Sort enumeration
 *
 * Represents valid sort_by values for listing discounts.
 *
 * @see https://developer.rechargepayments.com/2021-11/discounts#list-discounts
 * @see https://developer.rechargepayments.com/2021-01/discounts#list-discounts
 */
enum DiscountSort: string
{
    case ID_ASC = 'id-asc';
