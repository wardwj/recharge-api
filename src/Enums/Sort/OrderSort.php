...
/**
 * Order Sort enumeration
 *
 * Represents valid sort_by values for listing orders.
 *
...
enum OrderSort: string
{
    ...
    case SHIPPED_DATE_ASC = 'shipped_date-asc';
    case SHIPPED_DATE_DESC = 'shipped_date-desc';
    case SHIPPING_DATE_ASC = 'shipping_date-asc'; // Deprecated
    case SHIPPING_DATE_DESC = 'shipping_date-desc'; // Deprecated
