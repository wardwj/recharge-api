...
/**
 * Webhook Sort enumeration
 *
 * Represents valid sort_by values for listing webhooks.
 * Based on Recharge API sorting documentation for both 2021-01 and 2021-11.
 *
 * @see https://developer.rechargepayments.com/2021-11/sorting
 * @see https://developer.rechargepayments.com/2021-01/sorting
 */
enum WebhookSort: string
{
    case ID_ASC = 'id-asc';
