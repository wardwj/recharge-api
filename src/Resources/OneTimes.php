...
class OneTimes extends AbstractResource
{
    ...
    public function list(array $queryParams = []): Paginator
    {
        ...
        if (isset($queryParams['sort_by']) && $queryParams['sort_by'] instanceof OneTimeSort) {
        ...
        if (isset($queryParams['sort_by']) && is_string($queryParams['sort_by'])) {
            if (OneTimeSort::tryFromString($queryParams['sort_by']) === null) {
                throw new \InvalidArgumentException(
                    sprintf(
                        'Invalid sort_by value "%s". Allowed values: %s',
                        $queryParams['sort_by'],
                        implode(', ', array_column(OneTimeSort::cases(), 'value'))
                    )
                );
            }
        }
