...
class PaymentMethods extends AbstractResource
{
    ...
    public function list(array $queryParams = []): Paginator
    {
        ...
        try {
            ...
            if (isset($queryParams['sort_by']) && $queryParams['sort_by'] instanceof PaymentMethodSort) {
            ...
            if (isset($queryParams['sort_by']) && is_string($queryParams['sort_by'])) {
                if (PaymentMethodSort::tryFromString($queryParams['sort_by']) === null) {
                    throw new \InvalidArgumentException(
                        sprintf(
                            'Invalid sort_by value "%s". Allowed values: %s',
                            $queryParams['sort_by'],
                            implode(', ', array_column(PaymentMethodSort::cases(), 'value'))
                        )
                    );
                }
            }
